...
public class ATM_Main {
    ...
    private void handleAccountOptions(int accountType) {
        while(true){System.out.println("\nAccount Menu:");System.out.println("1. Check Balance");System.out.println("2. Deposit Money");System.out.println("3. Withdraw Money");System.out.println("4. Transfer Money");System.out.println("5. Back to Main Menu");System.out.print("Enter your choice: ");

        int choice=getValidInput();if(choice==5)break;

        switch(choice){case 1:checkBalance(accountType);break;case 2:depositMoney(accountType);break;case 3:withdrawMoney(accountType);break;case 4->transferMoney(accountType);default->System.out.println("Invalid choice. Please try again.");}}
    }
    ...
    private void updateAccountBalance(int accountType, float amount) {
        switch(accountType){case 1->savingsBalance+=amount;case 2->checkBalance+=amount;case 3->fixedBalance+=amount;}
    }
}
