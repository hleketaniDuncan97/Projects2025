...
public class ATM_Main {
    ...
    private void handleAccountOptions(int choice) {
        ...
        switch(choice){case 1->checkBalance();case 2->depositMoney();case 3->withdrawMoney();case 4->transferMoney();default->System.out.println("Invalid choice. Please try again.");}}
    }
